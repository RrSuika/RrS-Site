...
- <strong style="color:var(--accent)">Multidisciplinair werken draait om de juiste vragen stellen</strong>: ik kon de redenering van de elektrotechniekstudenten volgen omdat ik de basis zelf had geleerd, genoeg om te vragen naar warmteontwikkeling, rendement van transformatoren en de keuze van een voeding.
